        ...
        <section
            ...
            <div className='grid grid-cols-2 gap-6'>
                <div className='col-span-2 md:col-span-1 relative grid grid-cols-2 gap-6'>
                    <div className='col-span-2 2xl:col-span-1 bg-[#E5E5E5] rounded-[29px] h-auto 2xl:h-[240px] p-6'>
                ...
                <div className='col-span-2 md:col-span-1'>
                    <div className='bg-[#E5E5E5] p-6 mb-5 rounded-[33px]'>
                        ...
                        <AnimatedList
                            items={[
                                {
                                    text: 'Водопостачання з власної артезіанської свердловини з системою очистки води',
                                },
                                {
                                    text: 'Власна система очищення та водовідведення стічних вод',
                                },
                                {
                                    text: 'Система автоматичного поливу зелених насаджень',
                                },
                                {
                                    text: 'Автономне аварійне джерело електропостачання',
                                },
                            ]}
                        />
                    </div>
                    <div className='bg-[#E5E5E5] p-6 rounded-[33px]'>
                        <h3 className='mb-6 text-center md:text-left font-primary font-medium text-[20px] md:text-[26px] leading-[128%]'>
                        ...
                        <AnimatedList
                            items={[
                                {
                                    text: 'Система протипожежної сигналізації та оповіщення про пожежу',
                                },
                                {
                                    text: 'Система димовидалення та пожежогасіння',
                                },
                                {
                                    text: 'Блискавкозахист',
                                },
                                {
                                    text: 'Відеоспостереження та контроль доступу на територію комплексу',
                                },
                            ]}
                        />
                    </div>
