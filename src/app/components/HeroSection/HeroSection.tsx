      ...
      <div className="container mx-auto px-8 mt-6 md:mt-32 2xl:mt-60">
        ...
        <div className="relative">
          ...
          <p className="hidden 2xl:block absolute right-[40px] top-[20px] font-secondary text-[18px] text-white leading-[150%] w-[560px]">
            Житловий комплекс «Volna» - сучасний комплекс для комфортного
            проживання в Києві, на закритій території з охороною,
            на березі Дніпра.
          </p>
        ...
        <div className="bg-white rounded-3xl p-5 mt-5">
          <h2 className="text-black font-primary font-medium text-[32px] leading-[128%] mb-5">
            Чому краще жити саме в нас
          </h2>
          <div className="flex justify-baseline 2xl:justify-between items-center flex-wrap">
            <div className="font-secondary text-[15px] leading-[150%] p-5 text-black bg-[#F2F2F2] rounded-2xl my-3 mr-3">
          ...
          <div className="hidden md:flex justify-between items-center my-6 flex-wrap">
            <div className="flex items-center">
              <div className="font-secondary text-[18px] leading-[150%]">
                Підходить:
              </div>
