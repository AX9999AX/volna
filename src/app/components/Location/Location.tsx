  ...
  return (
    <section className="container mx-auto px-8 bg-[#F8F8F8]">
      <div className="grid grid-cols-2 gap-6 py-12">
        ...
        <div>
          <h2 className="font-primary font-medium text-[48px] my-6">
            Локація та інфраструктура
          </h2>
          <p className="font-secondary text-[18px] leading-[150%] text-[#4E4E4E]">
            ЖК VOLNA розташований у зручному та спокійному районі, де все
            необхідне — поруч. У безпосередній близькості знаходяться магазини,
            школи, дитячі садки, аптеки та сервіси.
          </p>
          <p className="font-secondary text-[18px] leading-[150%] text-[#4E4E4E] mt-4">
            <strong>Зручна транспортна розв’язка</strong> дозволяє швидко
            дістатися в будь-яку частину міста, як на авто, так і громадським
            транспортом.
          </p>
          <div className="flex justify-between items-center mt-10">
            <div className="flex items-center">
              <div className="font-secondary text-[18px] leading-[150%] text-[#4E4E4E]">
                До метро:
              </div>
